...
class Module {
     ...
     * @param {*} config 
     * 
     * config.run_at: either Module.RUN_AT_SERVER or Module.RUN_AT_CLIENT (default).
     */
    constructor(config = {}) {
        this.run_at = config.run_at || Module.RUN_AT_CLIENT;
        if (this.run_at === Module.RUN_AT_SERVER) {
    ...
    bootstrap(rootElement, rootModel) {
        ...
        this.document = rootElement.ownerDocument;
